 ...
 *************************************************************/
 ...
 // let rarityWeights = [
 //   addRarity('superrare', 1, 10),
 //   addRarity('rare', 10, 30),
 //   addRarity('original', 30, 100)
 // ];
 ...
 const layers = [
   ...
   addLayer('eyes'),//4
   addLayer('tshirt'), //5
   addLayer('moustaches'),//6
   addLayer('noses'),//7
   addLayer('haircut'), //8
   addLayer('mouth'), //9
   addLayer('glasses'), //10
   addLayer('misc'), //11
   addLayer('stickers'), //12
 ];
 ...
 // addRarityPercentForLayer('superrare', 'Beard', { 'superrare': 33, 'rare': 33, 'original': 33 });
 // addRarityPercentForLayer('superrare', 'Moustaches', { 'superrare': 50, 'rare': 25, 'original': 25 });
 // addRarityPercentForLayer('original', 'Headwear', { 'superrare': 20, 'rare': 30, 'original': 50 });
